...
SimpleForm.setup do |config|
  ...
  config.wrappers :prepend, tag: 'div', class: "form-group", error_class: 'error has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label, class: 'form-control'
  ...
  config.wrappers :append, tag: 'div', class: "form-group", error_class: 'error has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label, class: 'form-control'
    b.wrapper tag: 'div', class: 'col-md-4' do |input|
